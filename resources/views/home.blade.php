@extends('layouts.dmsapp')

@section('content')
    <!-- wrap @s -->
    <div class="nk-wrap ">
        <!-- main header @s -->
        @include("partials/dms-topbar")
        <!-- main header @e -->
        <!-- content @s -->
            ...
            <div class="container-fluid">
                <div class="nk-content-inner">
                    <div class="nk-content-body">
                            ...
                            <div class="nk-block-between">
                                ...
                                <div class="nk-block-head-content">
                                    <ul class="nk-block-tools g-3">
                                        <li>
                                            <div class="dropdown">
                                                <a href="#" class="btn btn-primary" data-bs-toggle="dropdown"><em class="icon ni ni-plus"></em> <span>Create</span></a>
                                        ...
                                        <li class="nk-block-tools-opt d-lg-none">
                                            <a href="#" class="btn btn-white btn-light btn-icon toggle" data-target="files-aside"><em class="icon ni ni-menu-alt-r"></em></a>
                                        </li>
                                    </ul>
                                </div><!-- .nk-block-head-content -->
                        ...
                        <div class="nk-fmg">
                            <div class="nk-fmg-aside" data-content="files-aside" data-bs-toggle-overlay="true" data-bs-toggle-body="true" data-bs-toggle-screen="lg" data-simplebar>
                                ...
                                <div class="nk-fmg-body-content">
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between position-relative">
                                            ...
                                            <div class="search-wrap ml-n1" data-search="search">
                                                                    ...
                                                                    <div class="nk-file-icon">
                                                                        <span class="nk-file-icon-type">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 72 72">
                                                                                <path fill="#0fac81" d="M57.5,31h-23c-1.4,0-2.5-1.1-2.5-2.5v-10c0-1.4,1.1-2.5,2.5-2.5h23c1.4,0,2.5,1.1,2.5,2.5v10
                                                                                    C60,29.9,58.9,31,57.5,31z" />
                                                                                                                                                        <path fill="#e05a45" d="M59.8,61H12.2C8.8,61,6,58,6,54.4V17.6C6,14,8.8,11,12.2,11h18.5c1.7,0,3.3,1,4.1,2.6L38,24h21.8
                                                                                    c3.4,0,6.2,2.4,6.2,6v24.4C66,58,63.2,61,59.8,61z" />
                                                                                                                                                                    <path display="none" fill="#e05a45" d="M62.1,61H9.9C7.8,61,6,59.2,6,57c0,0,0-31.5,0-42c0-2.2,1.8-4,3.9-4h19.3
                                                                                    c1.6,0,3.2,0.2,3.9,2.3l2.7,6.8c0.5,1.1,1.6,1.9,2.8,1.9h23.5c2.2,0,3.9,1.8,3.9,4v31C66,59.2,64.2,61,62.1,61z" />
                                                                                            <path fill="#06a57a" d="M7.7,59c2.2,2.4,4.7,2,6.3,2h45c1.1,0,3.2,0.1,5.3-2H7.7z" />
                                                                            </svg>
                                                                        </span>
                                                                    </div>
                                                                    ...
                                                                    <div class="nk-file-icon">
                                                                        <a class="nk-file-icon-link" href="#">
                                                                            <span class="nk-file-icon-type">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                                                    <g>
                                                                                        <rect x="32" y="16" width="28" height="15" rx="2.5" ry="2.5" style="fill:#0fac81" />
                                                                                        <path d="M59.7778,61H12.2222A6.4215,6.4215,0,0,1,6,54.3962V17.6038A6.4215,6.4215,0,0,1,12.2222,11H30.6977a4.6714,4.6714,0,0,1,4.1128,2.5644L38,24H59.7778A5.91,5.91,0,0,1,66,30V54.3962A6.4215,6.4215,0,0,1,59.7778,61Z" style="fill:#e05a45" />
                                                                                        <path d="M8.015,59c2.169,2.3827,4.6976,2.0161,6.195,2H58.7806a6.2768,6.2768,0,0,0,5.2061-2Z" style="fill:#06a57a" />
                                                                            ...
                                                                            <span class="nk-file-icon-type">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
                                                                                    <g>
                                                                                        <rect x="32" y="16" width="28" height="15" rx="2.5" ry="2.5" style="fill:#0fac81" />
                                                                                        <path d="M59.7778,61H12.2222A6.4215,6.4215,0,0,1,6,54.3962V17.6038A6.4215,6.4215,0,0,1,12.2222,11H30.6977a4.6714,4.6714,0,0,1,4.1128,2.5644L38,24H59.7778A5.91,5.91,0,0,1,66,30V54.3962A6.4215,6.4215,0,0,1,59.7778,61Z" style="fill:#e05a45" />
                                                                                        <path d="M7.7454,58.9807C9.9352,61.3864,12.4882,61.0163,14,61H59a6.3373,6.3373,0,0,0,5.2562-2.0193Z" style="fill:#06a57a" />
                                                ...
                                                <div class="nk-files nk-files-view-list">
                                                    ...
                                                    <div class="nk-files-list">
                                                        ...
                                                        <div class="nk-file-item nk-file">
                                                            ...
                                                            <div class="nk-file-members">
                                                                <div class="tb-lead">Only Me</div>
                                                                <div class="tb-shared"><em class="ni ni-link" data-bs-toggle="tooltip" data-placement="left" title="People with the link can view"></em></div>
                                                            </div>
                                                            <div class="nk-file-actions">
                                                                <div class="dropdown">
                                                                    <a href="" class="dropdown-toggle btn btn-sm btn-icon btn-trigger" data-bs-toggle="dropdown"><em class="icon ni ni-more-h"></em></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer modal-footer-stretch bg-light">
                <div class="modal-footer-between">
                    ...
                    <div class="g">
                        <ul class="btn-toolbar g-3">
                            <li><a href="#file-share" data-bs-toggle="modal" data-dismiss="modal" class="btn btn-outline-light btn-white">Share</a></li>
...
<div class="modal fade" tabindex="-1" role="dialog" id="file-upload">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <a href="#" class="close" data-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
            <form method="POST" action="{{route('incomingPost')}}"  >
                @csrf
                            ...
                            <div class="row gy-4">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="default-01">From<span class="text-danger">*</span> </label>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="default-01">Date<span class="text-danger">*</span></label>
                                        <div class="form-control-wrap">
                                            <input type="date" class="form-control" placeholder="Enter details">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label" for="default-01">Subject<span class="text-danger">*</span></label>
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" placeholder="Enter details">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select form-control form-control-lg" name="from_type" data-search="on">
                                                <option value="default_option">Staff</option>
                                                <option value="option_select_name">Contractor</option>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select form-control form-control-lg" name="from_type" data-search="on">
                                                <option value="default_option">Department</option>
                                                <option value="option_select_name">General</option>
                                                <option value="option_select_name">Personal</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select form-control form-control-lg" name="agency" data-search="on">
                                                <option value="default_option">Default Option</option>
                                                <option value="option_select_name">Option select name</option>
                                                <option value="option_select_name">Option select name</option>
                                            </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-select form-control form-control-lg" name="ministry" data-search="on">
                                                <option value="default_option">Default Option</option>
                                                <option value="option_select_name">Option select name</option>
                                                <option value="option_select_name">Option select name</option>
                                            </select>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="default-06">File Upload<span class="text-danger">*</span></label>
                                        <div class="form-control-wrap">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <div class="form-text-hint">
                                                <span class="overline-title">.00</span>
                                            </div>
                                            <input type="text" class="form-control" id="default-05" placeholder="Enter details">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="default-01">Remark</label>
                                        <div class="form-control-wrap">
                                            <textarea class="form-control no-resize" id="default-textarea" placeholder="Enter additional info here"></textarea>
                                        </div>
                                    </div>
                                </div>
